...
$SPNObjectId = "xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxx" # ObjectId Enterprise Application (SPN)
$LinkTokenPolicyBody  = @{
...
$DeleteTokenPolicyId = "xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxx"  # Id TokenLifeTimePolicy
